...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "28780046")
    API_HASH  = os.environ.get("API_HASH", "70a313c44ae696e30aab5e6b5e031d0d")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8580460686:AAFm0J0YZhHrxC5Ix9y8LHJowDbnLQWKY-w")
...
<b>‣ /Autorename:</b> ʀᴇɴᴀᴍᴇ ʏᴏᴜʀ ᴍᴇᴅɪᴀ ꜰɪʟᴇꜱ ʙʏ ɪɴᴄʟᴜᴅɪɴɢ 'ᴇᴘɪꜱᴏᴅᴇ' ᴀɴᴅ 'ǫᴜᴀʟɪᴛʏ' ᴠᴀʀɪᴀʙʟᴇꜱ ɪɴ ʏᴏᴜʀ ᴛᴇxᴛ, ᴛᴏ ᴇxᴛʀᴀᴄᴛ ᴇᴘɪꜱᴏᴅᴇ ᴀɴᴅ ǫᴜᴀʟɪᴛʏ ᴘʀᴇꜱᴇɴᴛ ɪɴ ᴛʜᴇ ᴏʀɪɢɪɴᴀʟ ꜰɪʟᴇɴᴀᴍᴇ.
"""
    
    ABOUT_TXT = """
<blockquote>
\u274D <u>ᴍʏ ɴᴀᴍᴇ</u> : <i>ᴀᴜᴛᴏ ʀᴇɴᴀᴍᴇ</i>
